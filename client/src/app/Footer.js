        ...
        <div className="row">
          <div className="small-12 medium-2 columns">
            <a href="http://zuehlke.com/" className="zue-logo-foot-wrap">
              <img className="zue-logo-foot" alt="Zühlke" src={require('../assets/images/logo-zuhlke.svg')} style={{ width: '120px' }} />
            </a>
          </div>
...
Privacy
      ...
      <div className="small-12 medium-4 columns">
        ...
        <ul className="zue-plain-list zue-social-list">
          ...
          <li>
            <a href="https://www.xing.com/" title="Xing" rel="noopener"><i className="icon-Xing" /></a>
          </li>
          <li>
            <a href="https://www.linkedin.com/company/z-hlke-group/" title="LinkedIn" rel="noopener">
              <i
